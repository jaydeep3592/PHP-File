    ...
    <div class="container mt-5">
        ...
        <div class="card">
            <div class="card-header">
                <h1>view Customer
                  <a type="button" class="btn btn-info btn-lg float-end me-2" href="{{url('/customer/add')}}">Add Customer</a>
                  <a type="button" class="btn btn-danger btn-lg float-end me-2" href="{{url('/customer/trash')}}">Deleted Items</a>
                </h1>
            </div>
            <div class="card-body">
